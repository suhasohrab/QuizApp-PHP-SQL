            ...
            <div class="col-md-12">
                    ...
                    if(@$_GET['q']== 'result' && @$_GET['eid']) 
                    {
                        ...
                        while($row=mysqli_fetch_array($q) )
                        {
                            ...
                            echo '<tr style="color:#66CCFF"><td>Total Questions</td><td>'.$qa.'</td></tr>
                                <tr style="color:#99cc32"><td>Score&nbsp;<span class="glyphicon glyphicon-ok-circle" aria-hidden="true"></span></td><td>'.$r.'</td></tr> ';       
                        }
                ...
                <?php
                    if(@$_GET['q']== 2) 
                    {
                        ...
                        <tr style="color:black;"><td><center><b>S.N.</b></center></td><td><center><b>Quiz</b></center></td><td><center><b>Question Solved</b></center></td><td><center><b>Score</b></center>';
                        $c=0;
                        while($row=mysqli_fetch_array($q) )
                        {
                        $eid=$row['eid'];
                        ...
                        {  $title=$row['title'];  }
                        $c++;
                        echo '<tr><td><center>'.$c.'</center></td><td><center>'.$title.'</center></td><td><center>'.$qa.'</center></td><td><center>'.$r.'</center></td><td><center>';
                        }
                        echo'</table></div>';
                    }
